...
public class LoginManager implements EntryPoint {
	public void onModuleLoad() {
		...
		horizontalPanel.setSize("426px", "151px");
		...
		verticalPanel.setSize("178px", "125px");
		...
		Hidden hidden_1 = new Hidden("Hidden name");
		rootPanel.add(hidden_1, 272, 152);
		hidden_1.setSize("20px", "20px");
	}
}
